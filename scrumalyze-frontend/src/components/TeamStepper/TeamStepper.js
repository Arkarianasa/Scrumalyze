...
const AddTeamStepper = () => {
    ...
    const [formValues, setFormValues] = useState({
        ...
        productGoals: [{ description: '', responsiblePersonDtoID: null }],
        productBacklog: { responsiblePersonDtoID: null, productGoalID: null, primaryPrioritizationSchemeID: null, secondaryPrioritizationSchemeID: null},
